...
(function () {
    ...
    URL = jde_root||tmp.substr(0,tmp.lastIndexOf("\/")+1).replace("_examples/","").replace("website/","");//这里你可以配置成ueditor目录在您网站的相对路径或者绝对路径（指以http开头的绝对路径）
    /**
    ...
    window.UEDITOR_CONFIG = {
       ...
       ,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        //涂鸦图片配置区
        ,scrawlUrl:jde_upp+"drawUp@Jde"
        ,scrawlPath:""                           //图片修正地址，同imagePath

        //附件上传配置区
        ,fileUrl:jde_upp+"fileUp@Jde"
        ,filePath:""                   //附件修正地址，同imagePath
        //,fileFieldName:"upfile"                    //附件提交的表单名，若此处修改，需要在后台对应文件修改对应参数

         //远程抓取配置区
        //,catchRemoteImageEnable:true               //是否开启远程图片抓取,默认开启
        ,catcherUrl:jde_upp+"getRemoteImage@Jde"
        ...
        //图片在线管理配置区
        ,imageManagerUrl:jde_upp+"imageManage@Jde"
        ,imageManagerPath:""                                    //图片修正地址，同imagePath

        //屏幕截图配置区
        ,snapscreenHost: document.location.host.split(":")[0]                                 //屏幕截图的server端文件所在的网站地址或者ip，请不要加http://
        ,snapscreenServerUrl: jde_upp+"imageUp@Jde"
        ,snapscreenPath: ""
        ,snapscreenServerPort: document.location.port                                   //屏幕截图的server端端口
        //,snapscreenImgAlign: ''                                //截图的图片默认的排版方式

        //word转存配置区
        ,wordImageUrl:jde_upp+"imageUp@Jde"
        ,wordImagePath:""                       //
        //,wordImageFieldName:"upfile"                     //word转存表单名若此处修改，需要在后台对应文件修改对应参数

        //获取视频数据的地址
        ,getMovieUrl:jde_upp+"getMovie@Jde"

        //工具栏上的所有的功能按钮和下拉框，可以在new编辑器的实例时选择自己需要的从新定义
        ,toolbars:[
            ['fullscreen', 'source', '|', 'undo', 'redo', '|',
                'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'removeformat', 'formatmatch','autotypeset','blockquote', 'pasteplain', '|', 'forecolor', 'backcolor', 'insertorderedlist', 'insertunorderedlist','selectall',/* 'cleardoc',*/ '|',
                'rowspacingtop', 'rowspacingbottom','lineheight', '|','touppercase','tolowercase','|','print', 'preview', 'searchreplace',
...
//           ]
        ...
        ,wordOverFlowMsg:'字数已超过10000.'    //<span style="color:red;">你输入的字符个数已经超出最大允许值，服务器可能会拒绝保存！</span>
        ...
        ,pageBreakTag:'_jdiy_page_break_tag_'
