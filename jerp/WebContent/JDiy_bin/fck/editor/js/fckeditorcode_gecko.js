...
//################################################################     added by folier:
var FCKHeightJiaCommand = function(){
    this.Name="HeightJia";
}
FCKHeightJiaCommand.prototype.Execute=function(){
    var o =window.frameElement;
    if(!o.getAttribute('_oldHeight')){
        o.setAttribute('_oldHeight',o.clientHeight);
    }
    o.style.height = (o.clientHeight+50)+"px";
}
FCKHeightJiaCommand.prototype.GetState = function () {
    return 0;
};

var FCKHeightJianCommand = function(){
    this.Name="HeightJian";
}
FCKHeightJianCommand.prototype.Execute=function(){
    var o =window.frameElement;
    if(!o.getAttribute('_oldHeight')){
        o.setAttribute('_oldHeight',o.clientHeight);
    }
    o.style.height = (Math.max(160 || 0, o.clientHeight-50))+"px";
}
FCKHeightJianCommand.prototype.GetState = function () {
    return 0;
};

var FCKHeightResetCommand = function(){
    this.Name="HeightReset";
}
FCKHeightResetCommand.prototype.Execute=function(){
    var o =window.frameElement;
    if(o.getAttribute('_oldHeight')) o.style.height = o.getAttribute('_oldHeight')+"px";
}
FCKHeightResetCommand.prototype.GetState = function () {
    return 0;
};
//################################################################
...
FCKCommands.GetCommand = function (A) {
    ...
    switch (A) {
        ...
        //added by Folier:
        case 'HeightJia':
            B = new FCKHeightJiaCommand();
            break;
        case 'HeightJian':
            B = new FCKHeightJianCommand();
            break;
        case 'HeightReset':
            B = new FCKHeightResetCommand();
            break;
...
FCKToolbarItems.GetItem = function (A) {
    ...
    switch (A) {
        ...
        //added by folier:
        case 'HeightJia':
            B = new FCKToolbarButton('HeightJia', FCKLang.HeightJia, null, null, true, null, 78);
            break;
        case 'HeightJian':
            B = new FCKToolbarButton('HeightJian', FCKLang.HeightJian, null, null, true, null, 77);
            break;
        case 'HeightReset':
            B = new FCKToolbarButton('HeightReset', FCKLang.HeightReset, null, null, true, null, 79);
            break;
